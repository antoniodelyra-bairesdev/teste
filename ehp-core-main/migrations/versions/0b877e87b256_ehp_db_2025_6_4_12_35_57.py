...
def upgrade() -> None:
    ...
    sa.Column('agen_cd_id', sa.Integer(), nullable=False),
    sa.Column('wiki_cd_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['agen_cd_id'], ['agent.agen_cd_id'], ),
    ...
    sa.ForeignKeyConstraint(['prof_cd_id'], ['profile.prof_cd_id'], ),
    sa.PrimaryKeyConstraint('auth_cd_id')
    )
    op.create_table('wikiclip_tag',
    sa.Column('wiki_cd_id', sa.Integer(), nullable=False),
    sa.Column('tag_cd_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['tag_cd_id'], ['tag.tag_cd_id'], ),
    sa.ForeignKeyConstraint(['wiki_cd_id'], ['wikiclip.wiki_cd_id'], ),
    ...
    sa.ForeignKeyConstraint(['auth_cd_id'], ['authentication.auth_cd_id'], ),
    ...
    sa.ForeignKeyConstraint(['auth_cd_id'], ['authentication.auth_cd_id'], ),
    sa.ForeignKeyConstraint(['coun_cd_id'], ['country.coun_cd_id'], ),
