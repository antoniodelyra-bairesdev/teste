...
def patch_redis():
    ...
    get_redis_patch = patch(
        "ehp.base.redis_storage.get_redis_client",
...
def patch_email():
    ...
    send_notification_patch = patch(
        "ehp.utils.email.send_notification",
        return_value=True
    )
...
def setup_mock_authentication(db_session, user_data=None):
    ...
    auth_email_patch = patch(
        "ehp.core.models.db.Authentication.get_by_email",
        return_value=mock_auth
    )

    auth_username_patch = patch(
        "ehp.core.models.db.Authentication.get_by_user_name",
        return_value=mock_auth
    )
...
def mock_session_data(session_id="test-session-id", user_data=None):
