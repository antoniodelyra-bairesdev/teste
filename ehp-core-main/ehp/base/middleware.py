...
async def get_user_session(
    ...
    if x_token_auth:
        if hasattr(request.state, "request_config"):
            request.state.request_config["user_session"] = (
                session_manager.get_session_from_token(x_token_auth)
            )
        else:
            request.state.request_config = {
                "user_session": session_manager.get_session_from_token(x_token_auth)
            }
