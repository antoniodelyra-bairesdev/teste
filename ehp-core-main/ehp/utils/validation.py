...
class RequestValidator:
    ...
    def validate_request_data(self, data: Dict[str, Any], model_class: BaseModel = None) -> Dict[str, Any]:
    ...
    async def validate_request(request: Request):
        ...
        if request.method in ["POST", "PUT", "PATCH"]:
            try:
                ...
                logging.getLogger("ehp.validation").debug(f"Failed to parse request body: {e}")
